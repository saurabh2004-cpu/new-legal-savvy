...
export default function Hero8({ cityName = "Tirap", className = "" }: Hero8Props) {
    return (
        <section
                    ...
                    <div className="text-left">
                        ...
                        <p
                            className="
                                ...
                                "
                        >
                            Facing severe financial hardship in {cityName}? Stop the endless cycle of
                                ...
                                <li className="flex items-start gap-3">
                                    ...
                                    <span
                                        className="
                                            ...
                                            "
                                    >
                                        Harassing calls from recovery agents in {cityName}?
                                    </span>
                                </li>
