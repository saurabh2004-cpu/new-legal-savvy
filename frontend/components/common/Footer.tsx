...
export default function Footer() {
    return (
        <footer className="w-full py-1 px-2 bg-[#D9D9D9]">
            {/* ── MAIN CONTENT ── */}
            <div className="max-w-8xl mx-auto rounded-xl px-4 md:px-8 py-8 lg:pt-20 overflow-hidden"
                style={{
            ...
            >
                <div className="max-w-7xl mx-auto flex flex-col space-y-6 lg:space-y-12 lg:justify-between">
                    {/* Logo */}
                    ...
                    <div className="flex flex-col lg:flex-row justify-between">
                        ...
                        <div className="grid grid-cols-2 sm:grid-cols-3 gap-x-8 gap-y-12 lg:gap-x-20 pt-2 lg:pt-0 geist-regular">
                                ...
                                <div key={ci} className="flex flex-col gap-6">
                                    {col.map((item) => (
                                        <Link
                                            key={`${item.label}-${ci}`}
                                            href={item.href}
                                            className="text-base md:text-lg text-[#c0c4d8] hover:text-white transition-colors duration-200"
                                        >
                                            {item.label}
                                        </Link>
                                    ))}
