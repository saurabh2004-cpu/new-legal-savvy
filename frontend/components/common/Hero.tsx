...
export default function Hero({ Heading, img, className, description }: HeroProps) {
  ...
  const isHeadingCenter = pathname === "/loan-settlement-by-bank" || pathname === "/loan-settlement-by-city" || pathname === "/loan-settlement-by-state" || pathname === "/resources" || isServicePage;
  ...
  return (
    <section className="w-full p-2">
      <div className={`${isHeadingCenter ? "h-full" : "xl:min-h-screen"} ${isServicePage ? "xl:min-h-screen" : ""}`}>
        <div className={`relative flex flex-col md:block w-full h-auto  rounded-[1rem] md:rounded-[1.rem] ${hoveredMenu ? "overflow-visible" : "overflow-hidden"} shadow-2xl  md:bg-black ${className}`}>
          ...
          >
            ...
            >
              {isServicePage ? (
                <div className="flex flex-col items-center justify-center text-center w-full max-w-4xl mx-auto pt-30 md:pt-24">
                ...
                <div className="flex flex-col lg:flex-row justify-between items-start lg:items-end w-full gap-10 lg:gap-28">
                  ...
                  <div className={`${isHeadingCenter ? "w-full text-center" : "max-w-4xl w-full"} `}>
                    <h1 className="text-[26px] sm:text-[36px] md:text-[54px] lg:text-[38px] xl:text-[67.02px] font-black text-white leading-[100%] tracking-normal mb-6 md:mb-8 geist-regular max-w-xl">
                      {Heading}
                    </h1>
                    ...
                    {pathname === '/' && < div className="flex flex-row items-center gap-4 md:gap-6 mt-2 md:mt-0">
                      ...
                      <div className="flex flex-col text-white gap-1">
                        <span className="text-xs sm:text-sm md:text-base font-normal geist-regular uppercase tracking-normal leading-tight md:leading-none opacity-90">
                  ...
                  {pathname === '/' && <div className="max-w-xl lg:max-w-3xl flex flex-col items-start lg:items-end text-left lg:text-right w-full mt-4 lg:mt-0">
                    <p className="text-white text-sm sm:text-base md:text-lg lg:text-xl tracking-normal leading-relaxed lg:leading-none opacity-95 mb-8 text-left lg:text-right geist-regular">
