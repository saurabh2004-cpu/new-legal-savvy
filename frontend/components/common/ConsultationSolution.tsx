...
export default function ConsultationSolution({ image, className }: { image: string, className?: string }) {
  ...
  return (
    <section ref={sectionRef} className={`  bg-[#E3DDD9] md:m-4 rounded-xl relative z-10 overflow-hidden ${className}`}>
      <div className="max-w-[120rem] mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="w-full flex flex-col justify-center items-center relative">
          ...
          <div className="w-full max-w-[100rem] mx-auto pt-3 pb-24 lg:py-3 md:pb-32 grid grid-cols-1 lg:grid-cols-3 gap-12 lg:gap-8 items-center relative z-10">
...
// export default function ConsultationSolution() {
//   const sectionRef = useRef<HTMLElement>(null);
//   const [isWider, setIsWider] = useState(false);
//   const isInView = useInView(sectionRef, { once: false });
...
//   return (
//     <section ref={sectionRef} className="pb-16 lg:pb-24 bg-[#E3DDD9] md:m-4 rounded-xl relative z-10 overflow-hidden">
//       <div className="max-w-[120rem] mx-auto px-4 sm:px-6 lg:px-8">
...
//           {/* 3-Column Content Grid */}
//           <div className="w-full max-w-[100rem] mx-auto py-24 lg:py-3 md:pb-32 grid grid-cols-1 lg:grid-cols-3 gap-12 lg:gap-8 items-center relative z-10">
...
//               animate={{ scale: isWider ? 1.6 : 1.0 }}
//               transition={{ duration: 0.6, ease: [0.16, 1, 0.3, 1] }}
//               className="w-[70vw] sm:w-[100vw] md:w-[70vw] lg:w-[70vw] xl:w-[70rem] max-w-none h-[6rem] sm:h-[10rem] md:h-[25rem]  xl:h-[15rem] -mt-20 sm:-mt-10 md:-mt-50 xl:-mt-12 pointer-events-none select-none z-0 relative flex justify-center overflow-visible"
//             >
//               <motion.div
//                 initial={{ opacity: 0, y: 50, scale: 2.4 }}
//                 whileInView={{ opacity: 1, y: 0, scale: 1.15 }}
...
//                 className="w-full h-full relative flex justify-center overflow-visible"
//               >
//                 <svg viewBox="0 0 1000 250" className="w-full h-full opacity-85 overflow-visible">
//                   <path id="text-curve" fill="transparent" d="M -200 310 Q 500 -180 1200 310" />
//                   <text className="font-sans font-medium" fontSize="55" fill="#2C3E50" letterSpacing="0.02em">
