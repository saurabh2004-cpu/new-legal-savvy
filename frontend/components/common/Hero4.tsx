...
// export default function Hero4({ title, description, image, className }: Hero4Props) {
//   const containerRef = useRef<HTMLDivElement>(null);
//   const [hoveredMenu, setHoveredMenu] = useState<"services" | "locations" | null>(null);
...
//       <div ref={containerRef} className={`relative h-[400vh] rounded-xl`}>
//         <div className="sticky top-2 h-screen w-full overflow-hidden flex items-center justify-center rounded-xl">
//           {/* ========================================================= */}
//           {/* NAVBAR (Z-30)                                             */}
//           {/* ========================================================= */}
//           <motion.div
...
//             <motion.h1
//               style={{ opacity: titleOpacity, y: titleY }}
//               className="geist-semibold text-[24px] sm:text-[36px] md:text-[67.02px] text-white tracking-tight uppercase leading-[1.1]"
//             >
//               {title}
//             </motion.h1>
//             <motion.p
//               style={{ opacity: descOpacity, y: descY }}
//               className="geist-semibold text-lg md:text-xl text-white mt-6 mb-12 leading-sung max-w-3xl mx-auto"
//             >
//               {description}
//             </motion.p>
