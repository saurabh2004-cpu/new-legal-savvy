...
export default function ContentSectionState({ stateName = "Tirap" }: ContentSectionProps) {
  return (
          ...
          <main className="lg:col-span-6 min-w-0">
            <article className="bg-white rounded-3xl shadow-sm border border-gray-100 p-8 md:p-12 prose prose-lg prose-blue max-w-none text-gray-700 leading-relaxed">
              ...
              <section id="introduction" className="mb-12 scroll-mt-32">
                ...
                >
                  Loan Settlement Across {stateName}
                </h1>
                <p className="mb-4">
                  Loan settlement means your lender agrees to accept one reduced payment that closes the account, instead of you continuing to pay the full outstanding balance. Legal Savvy works with borrowers throughout <strong>{stateName}</strong> and across India, reviewing your loan agreement and statement history before putting a One-Time Settlement proposal to your bank or NBFC. What a lender accepts depends on its own internal settlement policy and how long the account has been overdue.
                </p>
              ...
              <section id="credit-card-settlement" className="mb-12 scroll-mt-32">
                <h2 className="text-2xl font-bold text-gray-900 mb-6">
                  The Debt Recovery Tribunal Bench for {stateName}
                </h2>
                <p className="mb-4">
                  Debt Recovery Tribunals hear recovery applications from banks and NBFCs above the statutory threshold, and their benches are organised regionally rather than by city. If a lender files against you, the matter goes to the bench with jurisdiction over {stateName}. Filing does not close off settlement, and many accounts are settled while proceedings are pending. Legal Savvy prepares the file and appears alongside you.
                </p>
              </section>

              <section id="personal-loan-settlement" className="mb-12 scroll-mt-32">
                <h2 className="text-2xl font-bold text-gray-900 mb-6">
                  Lok Adalat Settlements in {stateName}
                </h2>
                <p className="mb-4">
                  Lok Adalat sittings are organised through the State Legal Services Authority and are regularly used to settle bank recovery matters. A settlement recorded at a Lok Adalat carries the force of a decree, which is why it is worth taking seriously. Referral usually depends on the lender agreeing to list the matter.
                </p>
              </section>
                ...
                <div className="space-y-6">
                  <div className="border-b border-gray-100 pb-6 last:border-0 hover:bg-gray-50 p-4 rounded-xl transition-colors">
                    <h3 className="font-bold text-gray-900 mb-2">
                      How do I settle a loan in {stateName}?
                    </h3>
                  ...
                  <div className="border-b border-gray-100 pb-6 last:border-0 hover:bg-gray-50 p-4 rounded-xl transition-colors">
                    <h3 className="font-bold text-gray-900 mb-2">
                      Which Debt Recovery Tribunal covers {stateName}?
                    </h3>
                    <p className="text-gray-600 m-0">
                      DRT benches are organised regionally, so the bench with jurisdiction over your account depends on where the lender files rather than on your home address. If a recovery application is filed against you, Legal Savvy confirms which bench applies and prepares the file for that forum.
                    </p>
                  </div>

                  <div className="border-b border-gray-100 pb-6 last:border-0 hover:bg-gray-50 p-4 rounded-xl transition-colors">
                    <h3 className="font-bold text-gray-900 mb-2">
                      Can a loan be settled through Lok Adalat in {stateName}?
                    </h3>
                    <p className="text-gray-600 m-0">
                      Yes. Lok Adalat sittings are organised through the State Legal Services Authority and are regularly used to settle bank recovery matters. A settlement recorded there carries the force of a decree. Referral usually depends on the lender agreeing to list the matter, so it is one route among several.
                    </p>
                  </div>

                  <div className="border-b border-gray-100 pb-6 last:border-0 hover:bg-gray-50 p-4 rounded-xl transition-colors">
                    <h3 className="font-bold text-gray-900 mb-2">
                      How do I complain about a recovery agent in {stateName}?
                    </h3>
                    <p className="text-gray-600 m-0">
                      Raise it with the lender's own grievance officer first and keep a record. If there is no reply within 30 days, or the reply is unsatisfactory, the matter can go to the RBI Ombudsman through the Complaint Management System portal. Documented dates, numbers and call records matter more than anything else.
                    </p>
                  </div>
