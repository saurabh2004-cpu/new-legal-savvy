...
const CONSULTANTS = [
  { src: assets.home.human1, alt: "Expert Consultant 1" },
  { src: assets.home.human2, alt: "Expert Consultant 2" },
  { src: assets.home.human3, alt: "Expert Consultant 3" },
  { src: assets.about.hero, alt: "Expert Consultant 4" },
];
