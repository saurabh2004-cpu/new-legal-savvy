...
export default function Hero({ service }: HeroProps) {
    ...
    return (
        <section className="relative max-w-[97vw] mx-auto pb-10 xl:pb-0 my-2 rounded-xl w-full min-h-screen bg-[#1B223C] overflow-hidden flex flex-col justify-center font-sans">
            {/* Background Glow */}
            ...
            {/* Main Content */}
            <div className="w-full max-w-[1600px] mx-auto px-6 md:px-11   z-10 relative flex-1 flex flex-col justify-center">
