    ...
    <section className="w-full py-1 px-2">
      <div className="w-full max-w-8xl mx-auto font-sans overflow-hidden">
        <motion.div
          ...
          className="group/banner relative w-full rounded-xl text-white min-h-[480px] sm:min-h-[550px] md:min-h-[600px] lg:min-h-[46.6875rem] flex flex-col justify-between p-8 sm:p-12 md:p-16 lg:p-20 border border-white/5  overflow-hidden cursor-default select-none"
        >
